...
- <img src="/ecg-recorder-ios/assets/img/app-icon.png" alt="ECG app icon" height="40">   [ECG Recorder for Polar H10 (iOS and iPadOS app)](/ecg-recorder-ios/)

  iOS and iPadOS app for recording, visualizing, and exporting ECG data from the Polar H10 heart rate sensor.
